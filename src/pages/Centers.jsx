...
export default function Centers() {
  ...
  useEffect(() => {
    if (!mapInstanceRef.current && mapRef.current && L) {
      ...
      const gardenIcon = L.divIcon({ className: 'center-marker center-marker--garden', html: '🟢', iconSize: [24, 24] });
      const prodIcon = L.divIcon({ className: 'center-marker center-marker--prod', html: '🔵', iconSize: [24, 24] });
