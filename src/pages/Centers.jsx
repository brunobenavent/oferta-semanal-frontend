...
const createGardenIcon = () => L.divIcon({
  ...
  html: `<div class="custom-marker-circle custom-marker--garden">
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="22" viewBox="0 0 24 28" fill="none">
      <circle cx="12" cy="14" r="11" stroke="#dc2626" stroke-width="1.8" fill="white"/>
      <path d="M8 14 C8 8, 12 4, 16 8 C14 6, 10 7, 8 14Z" fill="#dc2626"/>
      <path d="M12 18 L12 24" stroke="#dc2626" stroke-width="1.5" stroke-linecap="round"/>
    </svg>
  </div>`,
  iconSize: [40, 40],
  iconAnchor: [20, 40],
...
const createProdIcon = () => L.divIcon({
  ...
  html: `<div class="custom-marker-circle custom-marker--prod">
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="22" viewBox="0 0 24 28" fill="none">
      <circle cx="12" cy="14" r="11" stroke="#16a34a" stroke-width="1.8" fill="white"/>
      <path d="M8 14 C8 8, 12 4, 16 8 C14 6, 10 7, 8 14Z" fill="#16a34a"/>
      <path d="M12 18 L12 24" stroke="#16a34a" stroke-width="1.5" stroke-linecap="round"/>
    </svg>
  </div>`,
  iconSize: [40, 40],
  iconAnchor: [20, 40],
