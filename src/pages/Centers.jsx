  ...
  return (
    <div className="centers-page">
      ...
      <div className="centers-list">
        <h2><img src="/vigu-rojo.svg" alt="" style="width:18px;height:22px;vertical-align:middle;margin-right:6px" /> Garden Centers</h2>
        ...
        <h2><img src="/corazon-verde.svg" alt="" style="width:18px;height:16px;vertical-align:middle;margin-right:6px" /> Centros de Producción</h2>
        <div className="centers-grid">
