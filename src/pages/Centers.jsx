...
const createGardenIcon = () => L.divIcon({
  ...
  html: `<svg xmlns="http://www.w3.org/2000/svg" width="30" height="36" viewBox="-100 0 120 95">
...
const createProdIcon = () => L.divIcon({
  className: 'custom-marker',
  html: `<svg xmlns="http://www.w3.org/2000/svg" width="30" height="36" viewBox="-10 0 90 95">
